...
import sys, os, numpy as np, pandas as pd, h5py
...
if __name__=="__main__":
    ...
    activities_df["SBSmock"] = k_NB * k_ZI
    print(f"Mock range: {np.min(activities_df['SBSmock'])} - {np.max(activities_df['SBSmock'])}")
